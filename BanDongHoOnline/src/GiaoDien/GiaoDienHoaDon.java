...
// TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            String sql = "SELECT MONTH(NgayIn), SUM(ThanhTien) FROM HoaDon Group by month(NgayIn)";
            JDBCCategoryDataset data = new JDBCCategoryDataset(DataConnection.connection, sql);
            JFreeChart chart = ChartFactory.createLineChart("Doanh thu cửa hàng", "Ngày", "Thành Tiền",data, PlotOrientation.VERTICAL, false, true, true);
